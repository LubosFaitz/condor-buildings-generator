...
# Hodnoty tagu ``building``, ktere NEJSOU budova - tyhle se negeneruji:
#   'no'     - mapper vyslovne rika, ze to budova neni (schodiste ECP10, way 75656944)
#   'ruins'  - zricenina (Birnbeck Pier a Burnbeck Pier - mola, ne domy)
#   'roof'         - pristresek bez sten, ve tvych datech 3-7 m velky
#   'bridge'       - most, ne budova
#   'construction' - rozestaveno, budova tam jeste nestoji
NOT_A_BUILDING = {'no', 'ruins', 'roof', 'bridge', 'construction'}

# Objekty, ktere maji building=yes, ale podle jineho tagu je jasne, ze o dum nejde.
#   amenity=shelter - pristresek s lavickou; way 916027894 je takhle otagovane cele
#                     213 m dlouhe molo Grand Pier ve Weston-super-Mare
