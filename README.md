...
The same material as the powerlines and aerialways is used. The material comes from pylonesPylons.dds. The post is mapped to the wooden part of the texture, while the wire uses the dark grey part at the top. No new texture is required.
